    ...
    */
    ...
    public function searchFeeds($url, $body = null)
    {
        ...
        try {
            ...
            } elseif (strpos($contentType, 'application/rss+xml') !== false || strpos($contentType, 'text/xml') !== false || strpos($contentType, 'application/xml') !== false || strpos(substr($body, 0, 50), '<rss ') !== false) {
                $feeds[] = [
                    'url' => $url,
                    'type' => 'rss'
                ];
