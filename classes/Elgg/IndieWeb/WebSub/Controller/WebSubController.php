...
class WebSubController
{
    public function __invoke(\Elgg\Request $request)
    {
        ...
        elseif ($request->getParam('hub_mode') && $request->getParam('hub_topic') && $request->getParam('hub_challenge') && hash_equals($websub_hash, $websub_client->getHash($request->getParam('hub_topic')))) {
